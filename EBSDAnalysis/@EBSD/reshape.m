...
% invariant that id, rotations, pos and every prop are (r x c). Leaving pos
...
% object's own shape, and the channel dimension rides along behind it - n x k
% for a column shaped object, r x c x k for a grid. Without this a 3 channel
