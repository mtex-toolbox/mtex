...
% EBSD/calcGrains GrainSet/GrainSet Grain3d/Grain3d
  ...
  methods
    function grains = Grain2d(ebsd,V,F,D,I_FD,A_Db,A_Do)
      ...
      [grains.I_FDext,grains.I_FDint] = calcBoundary;
      ...
      %
      grains.boundaryEdgeOrder = BoundaryFaceOrder(grains.I_FDext,grains.I_DG);

      grains.meanRotation = calcMeanRotation(grains);
      ...
      function b = BoundaryFaceOrder(I_FD,I_DG)
