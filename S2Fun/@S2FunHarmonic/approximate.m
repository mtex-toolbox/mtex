function sF = approximate(nodes, y, varargin)
% computes a least square problem to get an approximation
%
% Syntax
%   sF = S2FunHarmonic.approximate(S2Grid, f)
%   sF = S2FunHarmonic.approximate(S2Grid, f, 'bandwidth', bandwidth, 'tol', TOL, 'maxit', MAXIT, 'weights', W)
%
% Input
