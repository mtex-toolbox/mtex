%% *|S2FunHarmonicSym|*
% This site only covers on top differences to |S2FunHarmonic|.
...
% At first lets define a function handle which takes <vector3d_index.html |vector3d|> as an argument and returns double and a symmetry:
...
%% Visualization
% The plot commands for a |S2FunHarmonicSym| plots the function only on the fundamenta Sector of the symmetrie by default.
