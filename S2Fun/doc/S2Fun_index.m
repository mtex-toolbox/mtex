%% *|S2Fun|*
%
% The |S2Fun| toolbox is a collection of MATLAB(R) classes for numerical computation with functions on the two-dimensional sphere.
...
%
% The underlying mathematical approach is accomplished via spherical harmonics which form an orthonormal basis on the two-dimensional sphere.
