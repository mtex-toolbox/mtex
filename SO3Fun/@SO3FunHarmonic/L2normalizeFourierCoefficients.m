...
% d_n^{k,l}(\beta) \,e^{-\mathrm i l\alpha} $. Hence the $L_2$ norm of
% the Wigner-D function $D_n^{k,l}$ was $1/\sqrt{2n+1}$.
% 
% Now since MTEX version 5.9 the Wigner-D functions have $L_2$ norm 1.
% Hence they are defined by $ D_n^{k,l}({\bf R}(\alpha,\beta,\gamma)) = 
% \sqrt{2n+1} \, \mathrm e^{-\mathrm i k\gamma} \mathrm d_n^{k,l}(\beta) \, 
% e^{-\mathrm i l\alpha} $.
%
