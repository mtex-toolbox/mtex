...
% compute ghat fast
tic; 
A1 = compute_ghat(N,fhat,'makeeven');
toc
...
tic; A2 = compute_ghat(N,fhat); toc
tic; B2 = compute_ghat_syminghat(N,fhat); toc

tic; A3 = compute_ghat(N,fhat,'isReal'); toc
tic; B3 = compute_ghat_syminghat(N,fhat,'isReal'); toc

tic; A4 = compute_ghat(N,fhat,'makeeven','isReal'); toc
