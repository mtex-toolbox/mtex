...
if isnumeric(SO3F1)
  ...
  %SO3F = SO3FunHarmonic.quadrature(f, 'bandwidth', min(getMTEXpref('maxSO3Bandwidth'),2*SO3F2.bandwidth));
elseif isnumeric(SO3F2)
  ...
  %SO3F = SO3FunHarmonic.quadrature(f, 'bandwidth', min(getMTEXpref('maxSO3Bandwidth'),2*max(SO3F1.bandwidth, SO3F2.bandwidth)));
end
