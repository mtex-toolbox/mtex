...
| T5 | `tests/checkMeanTensor.m` stops at a rank-3 quadrature assert that cannot pass at any halfwidth; left failing deliberately — **stale 2026-08-12**: it passes end to end in 3.05 s, now at `tests/slow/checkMeanTensor.m` with its unclosed figures removed | 1 | 1 | done | — | docs/doc-audit-plan.md item 9 |
