...
| C13 | Upload the Kikuchi `.mat` data — **done 2026-09-08**: `data/quartzPattern.mat` is committed, regenerated by `SHTextractor` from the EMsoft SHT database's alpha-quartz 20 kV master pattern after the file was wiped with the `mtexdata` cache on 2026-09-02 | 1 | 0 | done | — | doc/CrystalGeometry/CrystalOperations.m |
