...
% distribution function (ODF). Fixing the random seed makes the published
% file previews reproducible.
...
%%
% Remove the temporary files and restore the random-number state.
