...
% shortest diameter. If we imagine a very strong alignment of the long axes
...
% cumulative projection function of grains of grain boundary segments.
% These methods are heavily inspired by
...
% grain, we can basically derive the projection length for all angles
% within the interval $0:180$ degree.
...
%%
% The function <grain2d.paror.html |grains.paror|> returns the cumulative
% particle projection function normalized to 1. The projection angles can
% be regarded as the rotation angle of the particle (counterclockwise)
% while projecting from the y-axis onto the x-axis.
...
% from <grain2d.paror.html |PAROR|> as implemented in Mtex can be
% interpreted in the following way: the maximum position represents the
% preferred axis parallel to the longest projection and the normal the
% minimum position represents the preferred axis related to the normal to
% the shortest projection function.
