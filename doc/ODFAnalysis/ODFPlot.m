...
% $(\varphi_1,\Phi,\varphi_2)$ as Cartesian plot coordinates. The coarser
% evaluation grid keeps this overview practical while retaining its three
% model features.

plot3d(odf,'Bunge','resolution',10*degree,'figSize','large');
...
plot3d(odf,'axisAngle','resolution',10*degree,'figSize','large');
mtexColorMap('LaboTeX');
mtexColorbar('title','mrd');
