...
% change the the crystals undergo a phase transition from the inital phase,
...
% quite different. A typical example are the alpha and beta phase of
...
% crystal directions is that it independ of the
% <CrystalReferenceSystem.html convention used for the hexagonal cyrstal
% coordinate system>.
%
%% Child Variants
%
...
%%
% Sometimes once faces in inverse question, i.e., determine the |variantId|
...
plot(oriChild,'axisAngle','filled')
