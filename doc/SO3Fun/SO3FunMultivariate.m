...
%% 
% Now we call the quadrature command to get 4x1 |SO3F2| of type 
% <SO3FunHarmonic.SO3FunHarmonic |SO3FunHarmonic|>
SO3F2 = SO3FunHarmonic.quadrature(f, 'bandwidth', 50)
...
SO3F3 = SO3FunHarmonic(eye(10))

%%
% * This command stores the ten first <WignerFunctions.html Wigner-D functions> in |SO3F3|
