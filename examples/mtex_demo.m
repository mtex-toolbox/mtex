...
plotpdf(odf,[Miller(1,0,0,CS),Miller(0,0,1,CS)],'reduced');
%savefigure('pic/fibreodf1.pdf')

%%
plotpdf(odf,[Miller(1,0,0,CS),Miller(0,0,1,CS)],'reduced','absolute','edist')
%savefigure('pic/fibreodf2.pdf')

%%

plotpdf(odf,[Miller(1,0,0,CS),Miller(0,0,1,CS)],'reduced','gray','contourf')
