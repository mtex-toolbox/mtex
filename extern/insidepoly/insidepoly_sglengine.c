 /*************************************************************************
 * MATLAB MEX ROUTINE insidepoly_sglengine.c
 *  [in on] = insidepoly_sglengine(x, y, Px1, Py1, Px2, Py2, tol) OR
 *
 *  [in on] = insidepoly_sglengine(x, y, Px1, Py1, Px2, Py2, tol, 
 *                                 first, last)
 *
 * PURPOSE: engine for check points inside a 2D polygon
 * Engine for single (float) inputs
 *
 *  INPUTS:
 *  x, y: (n x 1) arrays
 ...
 *
 * Compilation:
 *  >> mex -O -v insidepoly_sglengine.c 
...
/* Working type */
#define TYPE float
/* Gateway of insidepoly_sglengine */
