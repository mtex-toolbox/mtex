function [m, o, lambda, eigv]  = mode(o,varargin)
% mode of a list of orientations, principle axes and moments of inertia
%
% Syntax
%   [m, q, lambda, V] = mode(ori)
%   [m, q, lambda, V] = mode(ori,'robust')
%   [m, q, lambda, V] = mode(ori,'weights',weights)
%
% Input
