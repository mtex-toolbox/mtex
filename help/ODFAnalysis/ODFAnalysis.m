...
% characteristics from an ODF. The following two mindmaps may give you an
...
% fibre ODF, or ODFs specified by Fourier coefficients. The central idea
% is that MTEX allows you to calculate with ODF as with ordinary number.
% That is you can multiply and ODF with a certain number, you can add,
% subtract or rotate ODFs. More precise information how to work with model
% ODFs in MTEX can be found in the section <ModelODFs.html ModelODFs>.
%
%% Estimating ODFs from EBSD Data or POole Figure Data
%
