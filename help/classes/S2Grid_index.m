...
% equidistributions
S2G = S2Grid('equispaced','points',100,'axial');  % specified by number of points
S2G = S2Grid('equispaced','RESOLUTION',5*degree,'axial');  % specified by resolution
...
plot(S2Grid('equispaced','points',100,'axial'))  % plot grid of nodes
