...
%
% A crystal frame in the argument list marks the plot as living in crystal
% coordinates, where X / Y / Z would be meaningless - there @sphericalPlot
% writes the Miller indices of the sector vertices instead.
%
...
%
%   h = annotateFrame(ax)
%   h = annotateFrame(ax,cs)  % a crystal frame suppresses the labels
%   h = annotateFrame(ax,ss)  % a specimen frame names the axes
