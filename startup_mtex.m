...
catch %#ok<CTCH> % add the pathes the old way
  
  pathes = { {''}, {'compatibility'},{'EBSDAnalysis'},...
    {'examples'},{'extern'},{'extern','export_fig'},...
    {'geometry'},{'geometry' 'geometry_tools'},{'geometry' 'sphericalProjections'},...
    {'interfaces'},{'interfaces','import_wizard'},{'interfaces','tools'},...
    {'obsolete'},{'ODFAnalysis'},{'ODFAnalysis','standardODFs'},...
    {'plotting'},{'plotting','tools'},...
    {'PoleFigureAnalysis'},{'tests'},...
    {'tools'},...
    {'tools','colormaps'}...
    {'tools','file_tools'}...
    {'tools','graph_tools'}...
