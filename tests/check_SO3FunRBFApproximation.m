...
for s = [1,1/sqrt(7),-sqrt(21),sqrt(127)]
    SO3F_Ref = s*SantaFe;
    SO3F_Approx = SO3FunRBF.approximation(SO3F_Ref,'mlsq','halfwidth',10*degree);
...
for s = [1,1/sqrt(7),-sqrt(21),sqrt(127)]
    SO3F_Ref = s*SantaFe;
    SO3F_Approx = SO3FunRBF.approximation(SO3F_Ref,'harmonic','halfwidth',7.5*degree);
    err = calcError(SO3F_Ref,SO3F_Approx);
...
for s = [1,1/sqrt(7),-sqrt(21),sqrt(127)]
    SO3F_Ref = s*SantaFe;
    SO3F_Approx = SO3FunRBF.approximation(SO3F_Ref,'halfwidth',10*degree); % 'lsqr' will fail
    err = calcError(SO3F_Ref,SO3F_Approx);
...
SO3F_Approx = SO3FunRBF.approximation(SO3F_Ref,'halfwidth',7.5*degree);
err = calcError(SO3F_Ref,SO3F_Approx);
