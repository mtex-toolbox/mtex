...
ni = notIndexedFrame('not'' indexed',[0.1 0.2 0.3]);
cs2 = crystalFrame('1',[2 3 4],[75 85 105]*degree, ...
  'Z||b','X||a*','mineral','O''Brien phase','color',[0.2 0.4 0.6]);
cs3 = crystalFrame('m-3m',[3.6 3.6 3.6], ...
...
cs4 = crystalFrame('m-3m',double(single([4.04 4.04 4.04])), ...
...
assert(contains(str,['crystalFrame(''m-3m'', [4.04 4.04 4.04], ...' newline]), ...
...
for k = 2:numel(e.CSList)
  assert(isa(e.CSList(k),'crystalFrame'), ...
