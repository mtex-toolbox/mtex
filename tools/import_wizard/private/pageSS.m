...
set(gui.hRotAngle        ,'Callback',@localUpdateAxes)
  ...
  function gui = localCreatePage()
    ...
    options = {...
      ...
      [' use ' upper(interf) ' interface flag ''convertSpatial2EulerReferenceFrame'' when importing the data'],...
      [' use ' upper(interf) ' interface flag ''convertEuler2SpatialReferenceFrame'' when importing the data']};
    ...
    for k=1:3
      ...
      rotateAngle(k) = uicontrol(...
        ...
        'Position',[m+rW+(k-1)*40 hscs-bH-2*m bH bH],...
        'String','0',...
        'Style','edit');
