...
function DisorientLegend_422(Deg, n1, n2)
    %%% Input: 
...
%     addpath('Necessary_Functions'); addpath('Plot_Functions'); addpath('Mesh_Functions');
    ...
    deg1 = pi/8; deg2 = atan(1); deg3 = atan(sqrt(1+(tan(pi/8))^2));
    deg4 = atan(sqrt(1+2*(tan(pi/8))^2));
    ...
    [A, B, C] = Create_Mesh_Pts_422(Deg, n1, n2);
...
%     w = 1; figure(w), hold all, grid on; 
    ...
    ptsv = rodri2volpreserv([x' y' z']);ptsa = areapreservingz(ptsv); 
    plot3(ptsa(:,1),ptsa(:,2),2*ones(1,100),':','Color',[0 0 0],'LineWidth',lw2);
    z = linspace(0,r,100);x = cos(pi/4)*sqrt(r^2 - z.^2); y=tan(pi/4)*x;
    ptsv = rodri2volpreserv([x' y' z']);ptsa = areapreservingz(ptsv);
    plot3(ptsa(:,1),ptsa(:,2),2*ones(1,100),':','Color',[0 0 0],'LineWidth',lw2);
    ...
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    if (alphaAng <= deg1)
        Plot_DL422_Range1(A, B, C, lw1);
    end
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    if(alphaAng>deg1 && alphaAng <= deg2)
        Plot_DL422_Range2(A, B, C, lw1);
    end
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    if(alphaAng > deg2 && alphaAng <= deg3)
        Plot_DL422_Range3(A, B, C, lw1);
    end
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    if(alphaAng > deg3 && alphaAng <= deg4)
        Plot_DL422_Range4(A, B, C, lw1);
    end
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    ...
    axis equal; axis off; 
    tempvar1 = sqrt(1+(tan(pi/8))^2 + (tan(pi/8))^2);
