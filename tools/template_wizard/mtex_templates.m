...
types = get_option(varargin,'type',{'EBSD','ODF','PoleFigure'});
...
for k=find(do_template_type)
  ...
  src = [src,...
          ...
          [ '% <html>' ...
            '<div class="descript">' ...
            '<h3 class="destitle">' template_files{k} '</h3>'  ...
            '<p class="destitle">'  title  ...
            ' </p><table width="100%" class="desinst"><tr><td align="left">'  ...
            ' Install : ' inst_link '' ...
            ' (' uninst_link ') ' ...
